  ...
  return (
    <form noValidate onSubmit={event => {
      ...
      <div className="col-sm-12 form-group">
        ...
        {managedBook.update &&
        <ResponsiveButton onClick={addNew} className="btn btn-success"
      ...
      <Tabs onSelect={onSelectTab} id="bookItemEditTabs" activeKey={tabEventKey} defaultActiveKey={'bookInfo'}>
        ...
        {managedBook.update && <Tab title={LABEL_BOOK_ADDITIONAL_INFO} eventKey={'bookAddInfo'}>
          <div className="book-form-tab"><BookAdditionalInformation managedBook={managedBook} settings={settings}/>
          </div>
        </Tab>}
