...
export const BookItemEdit = ({ onChange, tabEventKey, onSelectTab }) => {
    return (
        <form onChange={(event) => {
            ...
            <div className="col-sm-12 form-group">
                ...
                {tabEventKey === 'bookSubjects' ? <button className="btn btn-success" type="button">{LABEL_ADD_SUBJECT}</button> : ''}
            </div>
