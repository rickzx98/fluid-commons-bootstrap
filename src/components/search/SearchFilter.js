...
import {CollapseHeader, TextInput, ResponsiveButton} from '../common/';
import {GoogleBooks} from '../../api/google-books/';
import PropTypes from 'prop-types';
import FontAwesome from 'react-fontawesome';

export const SearchFilter = ({onSearchFilterChange, onSearchFilterSubmit, googleBooks})=> {
  return (<CollapseHeader panelStyle="panel panel-default"
    ...
    <form onChange={onSearchFilterChange} onSubmit={onSearchFilterSubmit} name="searchBooks">
      ...
      <div className="btn-group btn-group-md col-sm-12">
        <ResponsiveButton className="btn btn-warning pull-right" type="submit" label={LABEL_GO} icon={
