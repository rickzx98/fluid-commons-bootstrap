    ...
    render() {
        return (<div className={this.panelStyle}>
            <div className="panel-heading" onClick={this.collapse}>
                ...
                <div className="actions">{this.state.collapsed ? <i className="glyphicon glyphicon-menu-left" /> : <i className="glyphicon glyphicon-menu-down" />}</div>
            </div>
            {!this.state.collapsed && <div className="panel-body">{this.props.body}</div>}
        </div>);
    }
}
