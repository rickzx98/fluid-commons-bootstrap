import { BackButton, FontAwesome, ResponsiveButton, SearchSelector, Selector, TextInput } from '../common/';
...
export const BookSubjectForm = ({ subjects, onChange, managedSubject, cancelManagedSubject, addSubjectToManagedBook, updateManagedSubject }) => {
  return (<form className="form container-fluid" onSubmit={event => {
    ...
    <div className="form-group">
      <BackButton label={LABEL_CANCEL} confirm={cancelManagedSubject} />
      <ResponsiveButton type="submit" className="btn btn-primary" label={managedSubject.update ? LABEL_UPDATE : LABEL_SAVE}
