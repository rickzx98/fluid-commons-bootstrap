export const APP_NAME = 'INSURANCE';
...
export const LABEL_COUPON = 'Coupon';
export const LABEL_COMPANY = 'Company';
export const LABEL_CLAIM_DATE = 'Claim date';
export const LABEL_BLOCK_NUMBER = 'Block #';
export const LABEL_TIME = 'Time';
export const LABEL_TRANSACTION_DESCRIPTION = 'Transaction Description';
export const LABEL_ENCRYPTED_BLOCK = 'Encrypted Block';
