...
import { LABEL_AN_ERROR_HAS_OCCURRED, LABEL_ADD_BOOK} from '../labels';
...
export class BooksPage extends React.Component {
  ...
  setHeaders() {
    ...
    this.props.headerActions.setHeaderControls(headers);
  }
  ...
  render() {
    return (<BooksPageBody
      ...
      searchBooks={this.props.actions.searchBooks}
